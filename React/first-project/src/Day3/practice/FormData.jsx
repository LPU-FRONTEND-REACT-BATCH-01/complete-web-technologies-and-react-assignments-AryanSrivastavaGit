...
//             <br />
//             <br />
//             Gender : Male <input type="radio" name='gender' value="Male" onChange={handleChange}/> Female <input type="radio" name='gender' value="FeMale" onChange={handleChange}/>
//         </form>
//     </div>
//   )
// }
...
//         if(type==="checkbox"){
//             if(checked){
//                 setFormData({...formData, [name]:[...formData.skills, value]});
//                 // setFormData({...formData, skills:[...formData.skills, value]});
//             }else{
//                 setFormData({...formData, [name]:formData.skills.filter((skill)=>skill!=value)})
...
//             <br />
//             <br />
//             Skills: Html <input type="checkbox" name="skills" value="Html" onChange={handleChange}/> Css <input type="checkbox" name="skills" value="Css" onChange={handleChange} /> React <input type="checkbox" name="skills"  value="React" onChange={handleChange}/>
//         </form>
//     </div>
//   )
// }
...
//         {(results.length > 1 && results.length < 4) && <p>Medium Password</p> }
